import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{i as n,t as r}from"./Avatar-Dp6sof6I.js";import{D as i,E as a,Ei as o,Oi as s,Ti as c}from"./iframe-C9jzVbmX.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{c(),r(),a(),l=t(),u=[{name:`Alice Johnson`,src:`https://i.pravatar.cc/150?img=1`,key:`alice`},{name:`Bob Smith`,src:`https://i.pravatar.cc/150?img=2`,key:`bob`},{name:`Charlie Davis`,src:`https://i.pravatar.cc/150?img=3`,key:`charlie`},{name:`Diana Lee`,src:`https://i.pravatar.cc/150?img=4`,key:`diana`},{name:`Eve Park`,src:`https://i.pravatar.cc/150?img=5`,key:`eve`}],d={title:`Core/AvatarGroup`,component:s,tags:[`autodocs`],argTypes:{size:{control:`select`,options:[`xsm`,`sm`,`md`,`lg`,`xl`],description:`Size applied to all child avatars`}}},f={render:()=>(0,l.jsx)(s,{size:`lg`,children:u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key))})},p={render:()=>(0,l.jsxs)(s,{size:`lg`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:u.length-3})]})},m={render:()=>(0,l.jsxs)(s,{size:`lg`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:u.length-3,onClick:()=>alert(`Show all participants`)})]})},h={render:()=>(0,l.jsxs)(s,{size:`lg`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:44})]})},g={render:()=>(0,l.jsxs)(s,{size:`lg`,children:[(0,l.jsx)(n,{src:`https://i.pravatar.cc/150?img=1`,name:`Alice`,status:(0,l.jsx)(i,{variant:`success`,label:`Online`})}),(0,l.jsx)(n,{src:`https://i.pravatar.cc/150?img=2`,name:`Bob`,status:(0,l.jsx)(i,{variant:`warning`,label:`Away`})}),(0,l.jsx)(n,{src:`https://i.pravatar.cc/150?img=3`,name:`Charlie`,status:(0,l.jsx)(i,{variant:`error`,label:`Offline`})})]})},_={render:()=>(0,l.jsx)(`div`,{className:`x78zum5 xdt5ytf x1qh66ti`,children:[`xsm`,`sm`,`md`,`lg`,`xl`].map(e=>(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`h4`,{className:`xrcdmg7 x9ynric`,children:e}),(0,l.jsxs)(s,{size:e,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:u.length-3})]})]},e))})},v={render:()=>(0,l.jsxs)(s,{size:`lg`,children:[u.slice(0,4).map(e=>(0,l.jsx)(n,{name:e.name},e.key)),(0,l.jsx)(o,{count:1})]})},y={render:()=>(0,l.jsx)(s,{size:`lg`,children:(0,l.jsx)(n,{src:`https://i.pravatar.cc/150?img=1`,name:`Alice Johnson`})})},b={render:()=>(0,l.jsxs)(s,{size:`lg`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:999})]})},x={render:()=>(0,l.jsxs)(`div`,{className:`x78zum5 xdt5ytf x1qh66ti`,children:[(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`h4`,{className:`xrcdmg7 x9ynric`,children:`Short count (circle)`}),(0,l.jsxs)(s,{size:`md`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:5})]})]}),(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`h4`,{className:`xrcdmg7 x9ynric`,children:`Long count (pill)`}),(0,l.jsxs)(s,{size:`md`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:4912})]})]})]})},S={render:()=>(0,l.jsxs)(s,{size:`lg`,children:[u.slice(0,3).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:0})]})},C={render:()=>(0,l.jsx)(`div`,{style:{width:120,border:`1px dashed grey`,padding:8},children:(0,l.jsxs)(s,{size:`lg`,children:[u.slice(0,5).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:10})]})})},w={render:()=>(0,l.jsxs)(s,{size:`md`,children:[Array.from({length:10},(e,t)=>({key:`user-${t}`,name:`User ${t+1}`,src:`https://i.pravatar.cc/150?img=${t%70+1}`})).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:37})]})},T={render:()=>(0,l.jsxs)(s,{size:`lg`,"aria-label":`Project team`,children:[(0,l.jsx)(n,{src:u[0].src,name:u[0].name,href:`https://example.com/users/alice`}),(0,l.jsx)(n,{src:u[1].src,name:u[1].name,href:`https://example.com/users/bob`}),(0,l.jsx)(n,{src:u[2].src,name:u[2].name,onClick:()=>alert(`Open ${u[2].name}`)}),(0,l.jsx)(o,{count:u.length-3,onClick:()=>alert(`Show all members`)})]})},E={render:()=>(0,l.jsxs)(s,{size:`lg`,children:[u.slice(0,4).map(e=>(0,l.jsx)(n,{src:e.src,name:e.name},e.key)),(0,l.jsx)(o,{count:u.length-4})]})},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
