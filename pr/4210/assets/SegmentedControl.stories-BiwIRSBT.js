import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{n as i,t as a}from"./Icon-Csbga5uN.js";import{gn as o,hn as s,vn as c}from"./iframe-Do0XApyn.js";import{K as l,t as u,v as d,w as f}from"./esm-DA7gAIBC.js";var p,m,h,g,_,v,y,b,x,S,C;e((()=>{p=t(n()),s(),a(),u(),m=r(),h={title:`Core/SegmentedControl`,component:c,tags:[`autodocs`],argTypes:{size:{control:`select`,options:[`sm`,`md`,`lg`],description:`Size variant for the control`},isDisabled:{control:`boolean`,description:`Whether the entire control is disabled`},disabledMessage:{control:`text`,description:`Explains why the control is disabled (whole-group state, not per segment). With isDisabled, shows a tooltip on hover/keyboard focus and keeps the control focusable via aria-disabled (selection stays blocked). Use this instead of wrapping a disabled SegmentedControl in Tooltip.`}}},g={args:{size:`md`,isDisabled:!1},render:e=>{let[t,n]=(0,p.useState)(`grid`);return(0,m.jsxs)(c,{value:t,onChange:n,label:`View mode`,size:e.size,isDisabled:e.isDisabled,children:[(0,m.jsx)(o,{value:`grid`,label:`Grid`}),(0,m.jsx)(o,{value:`list`,label:`List`}),(0,m.jsx)(o,{value:`table`,label:`Table`})]})}},_={args:{size:`md`},render:e=>{let[t,n]=(0,p.useState)(`grid`);return(0,m.jsxs)(c,{value:t,onChange:n,label:`View mode`,size:e.size,children:[(0,m.jsx)(o,{value:`grid`,label:`Grid`,icon:(0,m.jsx)(i,{icon:f,color:`inherit`})}),(0,m.jsx)(o,{value:`list`,label:`List`,icon:(0,m.jsx)(i,{icon:l,color:`inherit`})}),(0,m.jsx)(o,{value:`table`,label:`Table`,icon:(0,m.jsx)(i,{icon:d,color:`inherit`})})]})}},v={args:{size:`sm`},render:e=>{let[t,n]=(0,p.useState)(`grid`);return(0,m.jsxs)(c,{value:t,onChange:n,label:`View mode`,size:e.size,children:[(0,m.jsx)(o,{value:`grid`,label:`Grid`,isLabelHidden:!0,icon:(0,m.jsx)(i,{icon:f,color:`inherit`})}),(0,m.jsx)(o,{value:`list`,label:`List`,isLabelHidden:!0,icon:(0,m.jsx)(i,{icon:l,color:`inherit`})})]})}},y={render:()=>{let[e,t]=(0,p.useState)(`day`);return(0,m.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`},children:[(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{style:{marginBottom:`8px`,fontSize:`12px`,color:`#666`},children:`Small`}),(0,m.jsxs)(c,{value:e,onChange:t,label:`Time period`,size:`sm`,children:[(0,m.jsx)(o,{value:`day`,label:`Day`}),(0,m.jsx)(o,{value:`week`,label:`Week`}),(0,m.jsx)(o,{value:`month`,label:`Month`})]})]}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{style:{marginBottom:`8px`,fontSize:`12px`,color:`#666`},children:`Medium (default)`}),(0,m.jsxs)(c,{value:e,onChange:t,label:`Time period`,size:`md`,children:[(0,m.jsx)(o,{value:`day`,label:`Day`}),(0,m.jsx)(o,{value:`week`,label:`Week`}),(0,m.jsx)(o,{value:`month`,label:`Month`})]})]}),(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{style:{marginBottom:`8px`,fontSize:`12px`,color:`#666`},children:`Large`}),(0,m.jsxs)(c,{value:e,onChange:t,label:`Time period`,size:`lg`,children:[(0,m.jsx)(o,{value:`day`,label:`Day`}),(0,m.jsx)(o,{value:`week`,label:`Week`}),(0,m.jsx)(o,{value:`month`,label:`Month`})]})]})]})}},b={render:()=>{let[e,t]=(0,p.useState)(`all`);return(0,m.jsxs)(c,{value:e,onChange:t,label:`Filter`,isDisabled:!0,children:[(0,m.jsx)(o,{value:`all`,label:`All`}),(0,m.jsx)(o,{value:`active`,label:`Active`}),(0,m.jsx)(o,{value:`completed`,label:`Completed`})]})}},x={render:()=>{let[e,t]=(0,p.useState)(`hourly`);return(0,m.jsxs)(c,{value:e,onChange:t,label:`Data granularity`,children:[(0,m.jsx)(o,{value:`hourly`,label:`Hourly`}),(0,m.jsx)(o,{value:`daily`,label:`Daily`}),(0,m.jsx)(o,{value:`weekly`,label:`Weekly`,isDisabled:!0})]})}},S={render:()=>{let[e,t]=(0,p.useState)(`all`);return(0,m.jsxs)(c,{value:e,onChange:t,label:`Filter`,isDisabled:!0,disabledMessage:`Choose a project to filter tasks`,children:[(0,m.jsx)(o,{value:`all`,label:`All`}),(0,m.jsx)(o,{value:`active`,label:`Active`}),(0,m.jsx)(o,{value:`completed`,label:`Completed`})]})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'md',
    isDisabled: false
  },
