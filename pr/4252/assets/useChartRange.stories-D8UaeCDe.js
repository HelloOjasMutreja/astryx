import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-B7Te67-h.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{t as i}from"./Text-Bt7jq58k.js";import{t as a}from"./Heading-DaPZub_W.js";import{c as o}from"./Stack-C7dTtCDZ.js";import{t as s}from"./Text-BYms8e3u.js";import{u as c}from"./iframe-BNc4jwR5.js";import{$ as l,At as u,Et as d,Ot as f,ot as p,t as m,tt as h}from"./src-DaTcnlIL.js";var g,_,v,y,b,x,S;e((()=>{g=t(n()),m(),c(),s(),_=r(),v={title:`Lab/useChartRange`},y={render:()=>{let e=h(),t=(0,g.useRef)(null),n=(0,g.useRef)(0),{xDomain:r,yDomain:s,push:c}=l({xWindow:300,yDomain:[0,100]});return(0,g.useEffect)(()=>{let e=setInterval(()=>{n.current+=1;let e=Math.sin(n.current*.04)*30+50+(Math.random()-.5)*10;c(n.current,e,t)},33);return()=>clearInterval(e)},[c]),(0,_.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,_.jsx)(a,{level:3,children:`Known Range (0-100%)`}),(0,_.jsx)(i,{type:`supporting`,color:`secondary`,children:`yDomain fixed at [0, 100]. useChartRange manages xDomain sliding window.`}),(0,_.jsxs)(u,{data:[],xKey:`t`,yKeys:[],xDomain:r,yDomain:s,height:200,children:[(0,_.jsx)(d,{horizontal:!0}),(0,_.jsx)(f,{position:`bottom`}),(0,_.jsx)(f,{position:`left`}),(0,_.jsx)(p,{handleRef:t,color:e.categorical(1)[0],bufferSize:300,lineWidth:1.5})]})]})}},b={render:()=>{let e=h(),t=(0,g.useRef)(null),n=(0,g.useRef)(0),{xDomain:r,yDomain:s,push:c}=l({xWindow:300,yPadding:.1});return(0,g.useEffect)(()=>{let e=setInterval(()=>{n.current+=1;let e=10+n.current*.05,r=Math.sin(n.current*.03)*e+50;c(n.current,r,t)},33);return()=>clearInterval(e)},[c]),(0,_.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,_.jsx)(a,{level:3,children:`Unknown Range (auto-tracks)`}),(0,_.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`No fixed yDomain. Range auto-expands as data reveals amplitude. Currently: [`,s[0].toFixed(1),`, `,s[1].toFixed(1),`]`]}),(0,_.jsxs)(u,{data:[],xKey:`t`,yKeys:[],xDomain:r,yDomain:s,height:200,children:[(0,_.jsx)(d,{horizontal:!0}),(0,_.jsx)(f,{position:`bottom`}),(0,_.jsx)(f,{position:`left`}),(0,_.jsx)(p,{handleRef:t,color:e.categorical(2)[1],bufferSize:300,lineWidth:1.5})]})]})}},x={render:()=>{let e=h(),t=(0,g.useRef)(null),n=(0,g.useRef)(0),r=(0,g.useRef)(0),{xDomain:s,yDomain:c,push:m}=l({xWindow:600,yCenter:!0,yPadding:.05});return(0,g.useEffect)(()=>{let e,i=()=>{n.current+=1,Math.random()<.003&&(r.current=30+Math.random()*50),r.current*=.97;let a=(Math.random()-.5)*2,o=r.current>.5?Math.sin(n.current*.5)*r.current*(.5+Math.random()*.5):0;m(n.current,a+o,t),e=requestAnimationFrame(i)};return e=requestAnimationFrame(i),()=>cancelAnimationFrame(e)},[m]),(0,_.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,_.jsx)(a,{level:3,children:`Zero-Centered (seismograph)`}),(0,_.jsxs)(i,{type:`supporting`,color:`secondary`,children:[`yCenter=true keeps 0 at center. Range auto-expands on quake bursts. Currently: [`,c[0].toFixed(1),`, `,c[1].toFixed(1),`]`]}),(0,_.jsxs)(u,{data:[],xKey:`t`,yKeys:[],xDomain:s,yDomain:c,yBaseline:`zero`,height:220,children:[(0,_.jsx)(d,{horizontal:!0}),(0,_.jsx)(f,{position:`bottom`}),(0,_.jsx)(f,{position:`left`}),(0,_.jsx)(p,{handleRef:t,color:e.categorical(5)[3],bufferSize:600,lineWidth:1,opacity:.9})]})]})}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  render: () => {
