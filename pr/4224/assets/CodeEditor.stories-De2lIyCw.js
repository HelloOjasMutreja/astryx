import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{gn as i,t as a}from"./src-CWx4gwTl.js";function o(e){let[t,n]=(0,s.useState)(e.value??u);return(0,c.jsx)(i,{label:`Code editor`,language:`typescript`,hasLineNumbers:!0,...e,value:t,onChange:n})}var s,c,l,u,d,f,p,m,h,g,_,v;t((()=>{s=e(n()),a(),c=r(),l={title:`Lab/CodeEditor`,component:i,tags:[`autodocs`],argTypes:{language:{control:`select`,options:[`typescript`,`javascript`,`json`,`html`,`css`,`python`,`bash`,`php`,`hack`,`yaml`,`markdown`,`plaintext`]},size:{control:`select`,options:[`sm`,`md`]},hasLineNumbers:{control:`boolean`},isReadOnly:{control:`boolean`}}},u=`function greet(name: string): string {
