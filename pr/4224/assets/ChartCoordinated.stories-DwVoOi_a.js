import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{t as r}from"./Text-c5LWyKai.js";import{t as i}from"./jsx-runtime-cM__dR4X.js";import{t as a}from"./Heading-BQr8-TFY.js";import{c as o}from"./Stack-mterni5z.js";import{t as s}from"./Text-_h16ESYs.js";import{s as c}from"./iframe-BY2UEiSX.js";import{B as l,Et as u,K as d,St as f,Z as p,bt as m,t as h,ut as g,wt as _}from"./src-CWx4gwTl.js";import{n as v,t as y}from"./useDataset-CbP6gsoH.js";var b,x,S,C,w;t((()=>{b=e(n()),h(),c(),s(),y(),x=i(),S={title:`Lab/Chart Interactions/Coordinated Views`},C={render:()=>{let e=p(),[t]=v(`cars.json`),[n,i]=(0,b.useState)(null),s=(0,b.useMemo)(()=>t.filter(e=>e.Horsepower!=null&&e.Miles_per_Gallon!=null&&e.Origin!=null),[t]),c=(0,b.useMemo)(()=>n?s.filter(e=>e.Horsepower>=n[0]&&e.Horsepower<=n[1]):s,[s,n]),h=(0,b.useMemo)(()=>s.map(e=>({hp:e.Horsepower,mpg:e.Miles_per_Gallon})),[s]),y=(0,b.useMemo)(()=>{let e=new Map;for(let t of c){let n=e.get(t.Origin)??{sum:0,count:0};n.sum+=t.Miles_per_Gallon,n.count+=1,e.set(t.Origin,n)}return[...e.entries()].map(([e,{sum:t,count:n}])=>({origin:e,avgMpg:Math.round(t/n*10)/10})).sort((e,t)=>t.avgMpg-e.avgMpg)},[c]),S=(0,b.useMemo)(()=>c.slice(0,10).map(e=>({name:e.Name,hp:e.Horsepower,mpg:e.Miles_per_Gallon,origin:e.Origin})),[c]);if(!s.length)return(0,x.jsx)(r,{type:`supporting`,children:`Loading\\u2026`});let C=e.categorical(3);return(0,x.jsxs)(o,{direction:`vertical`,gap:6,children:[(0,x.jsx)(a,{level:3,children:`Coordinated Views`}),(0,x.jsxs)(r,{type:`supporting`,color:`secondary`,children:[`Brush on the scatter to filter the bar chart and table below.`,n?` Showing ${c.length} cars with ${Math.round(n[0])}\u2013${Math.round(n[1])} HP.`:` Showing all ${s.length} cars.`]}),(0,x.jsxs)(o,{direction:`vertical`,gap:1,children:[(0,x.jsx)(r,{type:`label`,children:`Horsepower vs MPG`}),(0,x.jsxs)(u,{data:h,xKey:`hp`,yKeys:[`mpg`],yBaseline:`data`,height:280,children:[(0,x.jsx)(f,{horizontal:!0,vertical:!0}),(0,x.jsx)(_,{position:`bottom`}),(0,x.jsx)(_,{position:`left`}),(0,x.jsx)(g,{dataKey:`mpg`,color:C[0],radius:3}),(0,x.jsx)(d,{onBrush:e=>i(e.x),onClear:()=>i(null)}),n&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(l,{x:n[0],color:C[0],strokeDasharray:`none`}),(0,x.jsx)(l,{x:n[1],color:C[0],strokeDasharray:`none`})]})]})]}),(0,x.jsxs)(o,{direction:`vertical`,gap:1,children:[(0,x.jsx)(r,{type:`label`,children:`Average MPG by Origin (filtered)`}),(0,x.jsxs)(u,{data:y,xKey:`origin`,yKeys:[`avgMpg`],height:200,children:[(0,x.jsx)(f,{horizontal:!0}),(0,x.jsx)(_,{position:`bottom`}),(0,x.jsx)(_,{position:`left`}),(0,x.jsx)(m,{dataKey:`avgMpg`,color:C[1]})]})]}),(0,x.jsxs)(o,{direction:`vertical`,gap:1,children:[(0,x.jsx)(r,{type:`label`,children:`Top 10 cars (filtered)`}),(0,x.jsx)(`div`,{style:{fontSize:12,overflow:`auto`},children:(0,x.jsxs)(`table`,{style:{width:`100%`,borderCollapse:`collapse`},children:[(0,x.jsx)(`thead`,{children:(0,x.jsxs)(`tr`,{style:{borderBottom:`1px solid var(--color-border)`,textAlign:`left`},children:[(0,x.jsx)(`th`,{style:{padding:`4px 8px`},children:`Name`}),(0,x.jsx)(`th`,{style:{padding:`4px 8px`},children:`HP`}),(0,x.jsx)(`th`,{style:{padding:`4px 8px`},children:`MPG`}),(0,x.jsx)(`th`,{style:{padding:`4px 8px`},children:`Origin`})]})}),(0,x.jsx)(`tbody`,{children:S.map((e,t)=>(0,x.jsxs)(`tr`,{style:{borderBottom:`1px solid var(--color-border)`},children:[(0,x.jsx)(`td`,{style:{padding:`4px 8px`},children:e.name}),(0,x.jsx)(`td`,{style:{padding:`4px 8px`},children:e.hp}),(0,x.jsx)(`td`,{style:{padding:`4px 8px`},children:e.mpg}),(0,x.jsx)(`td`,{style:{padding:`4px 8px`},children:e.origin})]},t))})]})})]})]})}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  render: () => {
