import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{t as r}from"./Text-c5LWyKai.js";import{t as i}from"./jsx-runtime-cM__dR4X.js";import{t as a}from"./Heading-BQr8-TFY.js";import{c as o}from"./Stack-mterni5z.js";import{t as s}from"./Text-_h16ESYs.js";import{s as c}from"./iframe-BY2UEiSX.js";import{Et as l,St as u,Z as d,nt as f,t as p,wt as m}from"./src-CWx4gwTl.js";function h(e,t,n){let r=(0,g.useRef)(0);(0,g.useEffect)(()=>{let{base:i,amplitude:a,frequency:o,noise:s,spikeProbability:c,spikeSize:l,windowSize:u}=n,d=setInterval(()=>{r.current+=1;let n=i+Math.sin(r.current*o)*a+Math.sin(r.current*o*2.7)*a*.3+(Math.random()-.5)*s;Math.random()<c&&(n+=l*(.5+Math.random()*.5)),n=Math.max(0,Math.min(100,n)),e.current?.push(r.current,n),t([Math.max(0,r.current-u),r.current])},33);return()=>clearInterval(d)},[e,t,n])}var g,_,v,y,b,x,S,C;t((()=>{g=e(n()),p(),c(),s(),_=i(),v={title:`Lab/ChartStreamGL`},y={render:()=>{let e=d(),t=(0,g.useRef)(null),n=(0,g.useRef)(150),i=(0,g.useRef)(0),[s,c]=(0,g.useState)(150),[p,h]=(0,g.useState)([0,400]);return(0,g.useEffect)(()=>{let e=.008,r=setInterval(()=>{i.current+=1;let r=(Math.random()+Math.random()+Math.random()-1.5)*2,a=1e-4-e*e/2+e*r;n.current*=Math.exp(a),c(n.current),t.current?.push(i.current,n.current),h([Math.max(0,i.current-400),i.current])},50);return()=>clearInterval(r)},[]),(0,_.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,_.jsx)(a,{level:3,children:`Simulated Stock Ticker`}),(0,_.jsxs)(o,{direction:`horizontal`,gap:3,vAlign:`center`,children:[(0,_.jsx)(r,{type:`label`,children:`ACME Corp`}),(0,_.jsxs)(r,{type:`body`,children:[`$`,s.toFixed(2)]})]}),(0,_.jsxs)(l,{data:[{t:0,v:130},{t:1,v:170}],xKey:`t`,yKeys:[`v`],yDomain:[130,170],xDomain:p,yBaseline:`data`,height:220,children:[(0,_.jsx)(u,{horizontal:!0}),(0,_.jsx)(m,{position:`bottom`}),(0,_.jsx)(m,{position:`left`}),(0,_.jsx)(f,{handleRef:t,color:e.categorical(1)[0],bufferSize:400,lineWidth:1.5})]})]})}},b={render:()=>{let e=d(),t=(0,g.useRef)(null),n=(0,g.useRef)(null),i=(0,g.useRef)(null),[s,c]=(0,g.useState)([0,300]),[p,v]=(0,g.useState)([0,300]),[y,b]=(0,g.useState)([0,300]);h(t,c,{base:35,amplitude:15,frequency:.04,noise:8,spikeProbability:.01,spikeSize:40,windowSize:300}),h(n,v,{base:62,amplitude:5,frequency:.008,noise:2,spikeProbability:.005,spikeSize:15,windowSize:300}),h(i,b,{base:20,amplitude:12,frequency:.06,noise:10,spikeProbability:.02,spikeSize:30,windowSize:300});let x={data:[{t:0,v:0},{t:1,v:100}],xKey:`t`,yKeys:[`v`],yDomain:[0,100],height:150};return(0,_.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,_.jsx)(a,{level:3,children:`Server Metrics Dashboard`}),(0,_.jsxs)(o,{direction:`vertical`,gap:1,children:[(0,_.jsx)(r,{type:`label`,children:`CPU Usage (%)`}),(0,_.jsxs)(l,{...x,xDomain:s,children:[(0,_.jsx)(u,{horizontal:!0}),(0,_.jsx)(m,{position:`bottom`}),(0,_.jsx)(m,{position:`left`}),(0,_.jsx)(f,{handleRef:t,color:e.categorical(3)[0],bufferSize:300,lineWidth:1.5})]})]}),(0,_.jsxs)(o,{direction:`vertical`,gap:1,children:[(0,_.jsx)(r,{type:`label`,children:`Memory Usage (%)`}),(0,_.jsxs)(l,{...x,xDomain:p,children:[(0,_.jsx)(u,{horizontal:!0}),(0,_.jsx)(m,{position:`bottom`}),(0,_.jsx)(m,{position:`left`}),(0,_.jsx)(f,{handleRef:n,color:e.categorical(3)[1],bufferSize:300,lineWidth:1.5})]})]}),(0,_.jsxs)(o,{direction:`vertical`,gap:1,children:[(0,_.jsx)(r,{type:`label`,children:`Network I/O (Mbps)`}),(0,_.jsxs)(l,{...x,xDomain:y,children:[(0,_.jsx)(u,{horizontal:!0}),(0,_.jsx)(m,{position:`bottom`}),(0,_.jsx)(m,{position:`left`}),(0,_.jsx)(f,{handleRef:i,color:e.categorical(3)[2],bufferSize:300,lineWidth:1.5})]})]})]})}},x={render:()=>{let e=d(),t=(0,g.useRef)(null),n=(0,g.useRef)(0),i=(0,g.useRef)(0),[s,c]=(0,g.useState)([0,600]);return(0,g.useEffect)(()=>{let e,r=()=>{n.current+=1,Math.random()<.003&&(i.current=30+Math.random()*50),i.current*=.97;let a=(Math.random()-.5)*2,o=i.current>.5?Math.sin(n.current*.5)*i.current*(.5+Math.random()*.5):0;t.current?.push(n.current,a+o),c([Math.max(0,n.current-600),n.current]),e=requestAnimationFrame(r)};return e=requestAnimationFrame(r),()=>cancelAnimationFrame(e)},[]),(0,_.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,_.jsx)(a,{level:3,children:`Seismograph`}),(0,_.jsx)(r,{type:`supporting`,color:`secondary`,children:`yBaseline="zero" anchors 0 to center. Both axes from chart context.`}),(0,_.jsxs)(l,{data:[{t:0,v:-80},{t:1,v:80}],xKey:`t`,yKeys:[`v`],yDomain:[-80,80],xDomain:s,yBaseline:`zero`,height:220,children:[(0,_.jsx)(u,{horizontal:!0}),(0,_.jsx)(m,{position:`bottom`}),(0,_.jsx)(m,{position:`left`}),(0,_.jsx)(f,{handleRef:t,color:e.categorical(5)[3],bufferSize:600,lineWidth:1,opacity:.9})]})]})}},S={render:()=>{let e=d(),t=(0,g.useRef)(null),n=(0,g.useRef)(null),i=(0,g.useRef)(null),s=(0,g.useRef)(0),[c,p]=(0,g.useState)([0,400]);return(0,g.useEffect)(()=>{let e=setInterval(()=>{s.current+=1;let e=s.current,r=Math.sin(e*.02)*20;t.current?.push(e,50+r+Math.sin(e*.07)*10+(Math.random()-.5)*4),n.current?.push(e,50+r*.6+Math.cos(e*.05)*15+(Math.random()-.5)*6),i.current?.push(e,50+r*.3+Math.sin(e*.11)*8+(Math.random()-.5)*3),e>400&&p([Math.max(0,e-400),e])},33);return()=>clearInterval(e)},[]),(0,_.jsxs)(o,{direction:`vertical`,gap:4,children:[(0,_.jsx)(a,{level:3,children:`Multi-Sensor Overlay`}),(0,_.jsx)(r,{type:`supporting`,color:`secondary`,children:`Three streams sharing one chart, same xDomain, same yDomain=[0, 100].`}),(0,_.jsxs)(l,{data:[{t:0,v:0},{t:1,v:100}],xKey:`t`,yKeys:[`v`],yDomain:[0,100],xDomain:c,height:280,children:[(0,_.jsx)(u,{horizontal:!0}),(0,_.jsx)(m,{position:`bottom`}),(0,_.jsx)(m,{position:`left`}),(0,_.jsx)(f,{handleRef:t,color:e.categorical(3)[0],bufferSize:400,lineWidth:1.5,opacity:.8}),(0,_.jsx)(f,{handleRef:n,color:e.categorical(3)[1],bufferSize:400,lineWidth:1.5,opacity:.8}),(0,_.jsx)(f,{handleRef:i,color:e.categorical(3)[2],bufferSize:400,lineWidth:1.5,opacity:.8})]})]})}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  render: () => {
