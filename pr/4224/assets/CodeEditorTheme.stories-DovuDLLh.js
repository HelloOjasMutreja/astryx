import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{_ as i,a,c as o,d as s,f as c,g as l,h as u,i as d,m as f,n as p,o as m,p as h,r as g,s as _,u as v,y}from"./theme-zC-XzH0U.js";import{gn as b,t as x}from"./src-CWx4gwTl.js";function S({theme:e,_title:t,initialCode:n=E}){let[r,a]=(0,w.useState)(n);return(0,T.jsx)(i,{theme:e,children:(0,T.jsx)(b,{label:`Code editor`,value:r,onChange:a,language:`typescript`,hasLineNumbers:!0})})}function C({theme:e}){let[t,n]=(0,w.useState)(B);return(0,T.jsx)(i,{theme:e,children:(0,T.jsxs)(`div`,{children:[(0,T.jsx)(`div`,{style:{fontSize:11,fontWeight:600,color:`#888`,marginBottom:4,fontFamily:`monospace`},children:e.name}),(0,T.jsx)(b,{value:t,onChange:n,language:`typescript`,label:`Code editor`,hasLineNumbers:!0})]})})}var w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W;t((()=>{w=e(n()),x(),p(),T=r(),E=[`import {useState, useEffect} from 'react';`,``,`interface User {`,`  id: string;`,`  name: string;`,`  roles: string[];`,`}`,``,`const API_URL = "https://api.example.com";`,`const MAX_RETRIES = 3;`,``,`// Fetch user data with retry logic`,`async function fetchUser(id: string): Promise<User> {`,"  const response = await fetch(`${API_URL}/users/${id}`);",`  if (!response.ok) {`,"    throw new Error(`HTTP ${response.status}`);",`  }`,`  return response.json();`,`}`,``,`export function UserCard({id}: {id: string}) {`,`  const [user, setUser] = useState<User | null>(null);`,``,`  useEffect(() => {`,`    fetchUser(id).then(setUser);`,`  }, [id]);`,``,`  if (!user) return <div>Loading...</div>;`,``,`  return (`,`    <div className="card">`,`      <h2>{user.name}</h2>`,`      <span>{user.roles.length} roles</span>`,`    </div>`,`  );`,`}`].join(`
