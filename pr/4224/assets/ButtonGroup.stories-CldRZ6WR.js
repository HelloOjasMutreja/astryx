import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{t as n}from"./Button-D16xsf4E.js";import{t as r}from"./Button-Ncr6y4Fk.js";import{n as i,t as a}from"./Icon-CX7HEytI.js";import{n as o,t as s}from"./ButtonGroup-4D8Ftqa9.js";import{n as c,t as l}from"./IconButton-CBnzk087.js";import{t as u}from"./DropdownMenu-DYciN7yE.js";import{t as d}from"./DropdownMenu-DiICVErb.js";import{A as f,Jt as p,Kt as m,Sn as h,X as g,en as _,f as v,mn as y,t as b,wn as x}from"./esm-DeXniK4O.js";var S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{s(),r(),l(),a(),d(),b(),S=t(),C={title:`Core/ButtonGroup`,component:o,tags:[`autodocs`],argTypes:{orientation:{control:`select`,options:[`horizontal`,`vertical`]},size:{control:`select`,options:[`sm`,`md`,`lg`]}}},w={width:16,height:16},T={render:()=>(0,S.jsxs)(o,{label:`Clipboard actions`,children:[(0,S.jsx)(n,{label:`Copy`,icon:(0,S.jsx)(p,{style:w})}),(0,S.jsx)(n,{label:`Cut`,icon:(0,S.jsx)(f,{style:w})}),(0,S.jsx)(n,{label:`Paste`,icon:(0,S.jsx)(m,{style:w})})]})},E={render:()=>(0,S.jsxs)(o,{label:`Actions`,orientation:`vertical`,children:[(0,S.jsx)(n,{label:`Copy`}),(0,S.jsx)(n,{label:`Cut`}),(0,S.jsx)(n,{label:`Paste`})]})},D={render:()=>(0,S.jsxs)(o,{label:`Text formatting`,children:[(0,S.jsx)(c,{label:`Bold`,icon:(0,S.jsx)(i,{icon:y,size:`sm`})}),(0,S.jsx)(c,{label:`Italic`,icon:(0,S.jsx)(i,{icon:g,size:`sm`})}),(0,S.jsx)(c,{label:`Underline`,icon:(0,S.jsx)(i,{icon:v,size:`sm`}),tooltip:`Underline`})]})},O={render:()=>(0,S.jsxs)(o,{label:`History`,children:[(0,S.jsx)(n,{label:`Undo`,variant:`ghost`,icon:(0,S.jsx)(x,{style:w}),isIconOnly:!0}),(0,S.jsx)(n,{label:`Redo`,variant:`ghost`,icon:(0,S.jsx)(h,{style:w}),isIconOnly:!0})]})},k={render:()=>(0,S.jsxs)(`div`,{style:{display:`flex`,gap:16,alignItems:`center`},children:[(0,S.jsxs)(o,{label:`Small actions`,size:`sm`,children:[(0,S.jsx)(n,{label:`Copy`}),(0,S.jsx)(n,{label:`Paste`})]}),(0,S.jsxs)(o,{label:`Medium actions`,size:`md`,children:[(0,S.jsx)(n,{label:`Copy`}),(0,S.jsx)(n,{label:`Paste`})]}),(0,S.jsxs)(o,{label:`Large actions`,size:`lg`,children:[(0,S.jsx)(n,{label:`Copy`}),(0,S.jsx)(n,{label:`Paste`})]})]})},A={render:()=>(0,S.jsxs)(o,{label:`Save options`,children:[(0,S.jsx)(n,{label:`Save`,variant:`primary`}),(0,S.jsx)(n,{label:`Save options`,variant:`primary`,icon:(0,S.jsx)(_,{style:w}),isIconOnly:!0})]})},j={render:()=>(0,S.jsxs)(o,{label:`Merge options`,children:[(0,S.jsx)(n,{label:`Merge pull request`,variant:`primary`}),(0,S.jsx)(n,{label:`More merge options`,variant:`primary`,icon:(0,S.jsx)(_,{style:w}),isIconOnly:!0})]})},M={render:()=>(0,S.jsxs)(o,{label:`Edit actions`,children:[(0,S.jsx)(n,{label:`Edit`}),(0,S.jsx)(c,{label:`More options`,icon:(0,S.jsx)(_,{style:w})})]})},N={render:()=>(0,S.jsxs)(o,{label:`Approve action`,children:[(0,S.jsx)(n,{label:`Allow once`,variant:`primary`}),(0,S.jsx)(u,{hasChevron:!1,button:{label:`Allow options`,variant:`primary`,isIconOnly:!0,icon:(0,S.jsx)(i,{icon:`chevronDown`})},items:[{label:`Allow for 30 minutes`},{label:`Always allow`}]})]})},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
