import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{t as r}from"./Text-c5LWyKai.js";import{t as i}from"./jsx-runtime-cM__dR4X.js";import{t as a}from"./Field-BV1CTol1.js";import{t as o}from"./Text-_h16ESYs.js";import{t as s}from"./Field-Div-tiDq.js";import{n as c,t as l}from"./Selector-C-OFUSiG.js";import{n as u,t as d}from"./FormLayout-Ct8cdUvO.js";import{n as f,t as p}from"./TextInput-DNp0uFRq.js";function m({direction:e}){let[t,n]=(0,h.useState)(``),[r,i]=(0,h.useState)(``),[a,o]=(0,h.useState)(``);return(0,g.jsxs)(u,{direction:e,children:[(0,g.jsx)(f,{label:`Name`,value:t,onChange:n}),(0,g.jsx)(f,{label:`Email`,value:r,onChange:i}),(0,g.jsx)(f,{label:`Bio`,value:a,onChange:o})]})}var h,g,_,v,y,b,x,S,C,w;t((()=>{h=e(n()),d(),p(),l(),s(),o(),g=i(),_={title:`Core/FormLayout`,component:u,tags:[`autodocs`],args:{direction:`vertical`},argTypes:{direction:{control:`select`,options:[`vertical`,`horizontal`,`horizontal-labels`],description:`Direction of field arrangement`}}},v={name:`Vertical (Default)`,render:e=>(0,g.jsx)(m,{direction:e.direction})},y={name:`Horizontal`,args:{direction:`horizontal`},render:e=>{let[t,n]=(0,h.useState)(``),[r,i]=(0,h.useState)(``);return(0,g.jsxs)(u,{direction:e.direction,children:[(0,g.jsx)(f,{label:`First Name`,value:t,onChange:n}),(0,g.jsx)(f,{label:`Last Name`,value:r,onChange:i})]})}},b={name:`Horizontal Labels (Settings)`,args:{direction:`horizontal-labels`},render:e=>{let[t,n]=(0,h.useState)(`Jane Doe`),[r,i]=(0,h.useState)(`jane@example.com`),[a,o]=(0,h.useState)(`America/Los_Angeles`);return(0,g.jsxs)(u,{direction:e.direction,children:[(0,g.jsx)(f,{label:`Display Name`,value:t,onChange:n}),(0,g.jsx)(f,{label:`Email`,value:r,onChange:i}),(0,g.jsx)(c,{label:`Timezone`,value:a,onChange:e=>o(e),options:[{label:`Pacific Time`,value:`America/Los_Angeles`},{label:`Eastern Time`,value:`America/New_York`},{label:`UTC`,value:`UTC`}]})]})}},x={name:`Mixed Controls`,render:()=>{let[e,t]=(0,h.useState)(``),[n,r]=(0,h.useState)(`viewer`);return(0,g.jsxs)(u,{children:[(0,g.jsx)(f,{label:`Name`,value:e,onChange:t}),(0,g.jsx)(c,{label:`Role`,value:n,onChange:e=>r(e),options:[{label:`Viewer`,value:`viewer`},{label:`Editor`,value:`editor`},{label:`Admin`,value:`admin`}]}),(0,g.jsx)(a,{label:`Notifications`,inputID:`notif-group`,children:(0,g.jsxs)(`div`,{className:`x78zum5 xdt5ytf x1jnr06f`,id:`notif-group`,children:[(0,g.jsxs)(`label`,{className:`x78zum5 x6s0dn4 x167g77z`,children:[(0,g.jsx)(`input`,{type:`checkbox`,defaultChecked:!0}),` Email`]}),(0,g.jsxs)(`label`,{className:`x78zum5 x6s0dn4 x167g77z`,children:[(0,g.jsx)(`input`,{type:`checkbox`}),` SMS`]}),(0,g.jsxs)(`label`,{className:`x78zum5 x6s0dn4 x167g77z`,children:[(0,g.jsx)(`input`,{type:`checkbox`,defaultChecked:!0}),` Push`]})]})})]})}},S={name:`Nested Layouts`,render:()=>{let[e,t]=(0,h.useState)(``),[n,r]=(0,h.useState)(``),[i,a]=(0,h.useState)(``),[o,s]=(0,h.useState)(``),[c,l]=(0,h.useState)(``),[d,p]=(0,h.useState)(``);return(0,g.jsxs)(u,{children:[(0,g.jsxs)(u,{direction:`horizontal`,children:[(0,g.jsx)(f,{label:`First Name`,value:e,onChange:t}),(0,g.jsx)(f,{label:`Last Name`,value:n,onChange:r})]}),(0,g.jsx)(f,{label:`Email`,value:i,onChange:a}),(0,g.jsxs)(u,{direction:`horizontal`,children:[(0,g.jsx)(f,{label:`City`,value:o,onChange:s}),(0,g.jsx)(f,{label:`State`,value:c,onChange:l}),(0,g.jsx)(f,{label:`ZIP`,value:d,onChange:p})]})]})}},C={name:`In a Dialog`,render:()=>{let[e,t]=(0,h.useState)(`Jane Doe`),[n,i]=(0,h.useState)(`jane@example.com`);return(0,g.jsxs)(`div`,{className:`xtfardp xur7f20 x17fpy1y xb3r6kr`,children:[(0,g.jsx)(`div`,{className:`x1tamke2 x915a4u`,children:(0,g.jsx)(r,{type:`label`,children:`Edit Profile`})}),(0,g.jsx)(`div`,{className:`x1tamke2`,children:(0,g.jsx)(`form`,{id:`edit-profile`,onSubmit:t=>{t.preventDefault(),alert(`Saved: ${e}, ${n}`)},children:(0,g.jsxs)(u,{children:[(0,g.jsx)(f,{label:`Name`,value:e,onChange:t}),(0,g.jsx)(f,{label:`Email`,value:n,onChange:i})]})})}),(0,g.jsxs)(`div`,{className:`x78zum5 x13a6bvl x167g77z x1tamke2 xz14g06`,children:[(0,g.jsx)(`button`,{className:`x1ff1495 x1kogg8i x1gs6z28 x1ypdohk xif65rj x1dr8pv1 xka2uk4`,type:`button`,children:`Cancel`}),(0,g.jsx)(`button`,{className:`x1ff1495 x1kogg8i x1gs6z28 x1ypdohk xif65rj xtzjzor xfungia`,type:`submit`,form:`edit-profile`,children:`Save`})]})]})}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
