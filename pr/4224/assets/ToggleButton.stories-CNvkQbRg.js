import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{n as i,t as a}from"./Icon-CX7HEytI.js";import{i as o,n as s,t as c}from"./ToggleButton-B-46Hwhu.js";import{J as l,K as u,S as d,X as f,b as p,f as m,gn as h,it as g,mn as _,t as v,un as y,vn as b,w as x}from"./esm-DeXniK4O.js";import{I as S,M as C,i as w,m as T,o as E,t as D,v as O}from"./esm-DSYddTLN.js";var k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W;t((()=>{k=e(n()),c(),v(),D(),a(),A=r(),j={width:16,height:16},M={title:`Core/ToggleButton`,component:s,tags:[`autodocs`],argTypes:{label:{control:`text`},isPressed:{control:`boolean`},size:{control:`select`,options:[`sm`,`md`,`lg`]},isDisabled:{control:`boolean`},isLoading:{control:`boolean`}}},N={render:function(){let[e,t]=(0,k.useState)(!1);return(0,A.jsx)(s,{label:`Bold`,icon:(0,A.jsx)(_,{style:j}),isPressed:e,onPressedChange:t,isIconOnly:!0})}},P={render:function(){let[e,t]=(0,k.useState)(!1),[n,r]=(0,k.useState)(!0);return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,A.jsx)(s,{label:`Favorite`,icon:(0,A.jsx)(d,{style:j}),pressedIcon:(0,A.jsx)(E,{style:j}),isPressed:e,onPressedChange:t,isIconOnly:!0}),(0,A.jsx)(s,{label:`Bookmark`,icon:(0,A.jsx)(y,{style:j}),pressedIcon:(0,A.jsx)(C,{style:j}),isPressed:n,onPressedChange:r,isIconOnly:!0})]})}},F={render:function(){let[e,t]=(0,k.useState)(!1);return(0,A.jsx)(s,{label:`Active`,isPressed:e,onPressedChange:t,children:`Active`})}},I={args:{label:`Disabled toggle`,isPressed:!1,isDisabled:!0,icon:(0,A.jsx)(_,{style:j})}},L={args:{label:`Loading toggle`,isPressed:!0,isLoading:!0,icon:(0,A.jsx)(d,{style:j})}},R={render:function(){let[e,t]=(0,k.useState)({}),n=e=>t(t=>({...t,[e]:!t[e]}));return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8,alignItems:`center`},children:[(0,A.jsx)(s,{label:`Small`,size:`sm`,icon:(0,A.jsx)(_,{style:j}),isPressed:!!e.sm,onPressedChange:()=>n(`sm`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Medium`,size:`md`,icon:(0,A.jsx)(_,{style:j}),isPressed:!!e.md,onPressedChange:()=>n(`md`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Large`,size:`lg`,icon:(0,A.jsx)(_,{style:{width:20,height:20}}),isPressed:!!e.lg,onPressedChange:()=>n(`lg`),isIconOnly:!0})]})}},z={render:function(){let[e,t]=(0,k.useState)(`list`);return(0,A.jsxs)(o,{value:e,onChange:t,label:`View mode`,children:[(0,A.jsx)(s,{value:`list`,label:`List view`,icon:(0,A.jsx)(u,{style:j}),isIconOnly:!0}),(0,A.jsx)(s,{value:`grid`,label:`Grid view`,icon:(0,A.jsx)(x,{style:j}),isIconOnly:!0})]})}},B={render:function(){let[e,t]=(0,k.useState)([]);return(0,A.jsxs)(o,{type:`multiple`,value:e,onChange:t,label:`Text formatting`,children:[(0,A.jsx)(s,{value:`bold`,label:`Bold`,icon:(0,A.jsx)(_,{style:j}),isIconOnly:!0}),(0,A.jsx)(s,{value:`italic`,label:`Italic`,icon:(0,A.jsx)(f,{style:j}),isIconOnly:!0}),(0,A.jsx)(s,{value:`underline`,label:`Underline`,icon:(0,A.jsx)(m,{style:j}),isIconOnly:!0})]})}},V={render:function(){let[e,t]=(0,k.useState)(!1);return(0,A.jsx)(s,{label:e?`Unmute notifications`:`Mute notifications`,icon:(0,A.jsx)(h,{style:j}),pressedIcon:(0,A.jsx)(b,{style:j}),isPressed:e,onPressedChange:t,isIconOnly:!0})}},H={render:function(){let[e,t]=(0,k.useState)({bold:!0,italic:!1,underline:!0,strikethrough:!1,link:!1}),n=e=>t(t=>({...t,[e]:!t[e]}));return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:4},children:[(0,A.jsx)(s,{label:`Bold`,icon:(0,A.jsx)(i,{icon:_,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:S,size:`sm`,color:`accent`}),isPressed:e.bold,onPressedChange:()=>n(`bold`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Italic`,icon:(0,A.jsx)(i,{icon:f,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:T,size:`sm`,color:`accent`}),isPressed:e.italic,onPressedChange:()=>n(`italic`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Underline`,icon:(0,A.jsx)(i,{icon:m,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:w,size:`sm`,color:`accent`}),isPressed:e.underline,onPressedChange:()=>n(`underline`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Strikethrough`,icon:(0,A.jsx)(i,{icon:p,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:p,size:`sm`,color:`accent`}),isPressed:e.strikethrough,onPressedChange:()=>n(`strikethrough`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Link`,icon:(0,A.jsx)(i,{icon:l,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:l,size:`sm`,color:`success`}),isPressed:e.link,onPressedChange:()=>n(`link`),isIconOnly:!0})]})}},U={render:function(){let[e,t]=(0,k.useState)({star:!1,heart:!1,bookmark:!0,bell:!1}),n=e=>t(t=>({...t,[e]:!t[e]}));return(0,A.jsxs)(`div`,{style:{display:`flex`,gap:8},children:[(0,A.jsx)(s,{label:`Star`,icon:(0,A.jsx)(i,{icon:d,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:E,size:`sm`,color:`yellow`}),isPressed:e.star,onPressedChange:()=>n(`star`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Like`,icon:(0,A.jsx)(i,{icon:g,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:O,size:`sm`,color:`red`}),isPressed:e.heart,onPressedChange:()=>n(`heart`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Save`,icon:(0,A.jsx)(i,{icon:y,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:C,size:`sm`,color:`blue`}),isPressed:e.bookmark,onPressedChange:()=>n(`bookmark`),isIconOnly:!0}),(0,A.jsx)(s,{label:`Follow`,icon:(0,A.jsx)(i,{icon:h,size:`sm`,color:`secondary`}),pressedIcon:(0,A.jsx)(i,{icon:h,size:`sm`,color:`accent`}),isPressed:e.bell,onPressedChange:()=>n(`bell`),isIconOnly:!0})]})}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
