import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{D as n,E as r}from"./iframe-BY2UEiSX.js";var i,a,o,s,c,l,u,d,f,p,m,h,g,_,v,y;e((()=>{r(),i=t(),a={title:`Core/ProgressBar`,component:n,tags:[`autodocs`],argTypes:{value:{control:{type:`range`,min:0,max:100,step:1},description:`Current value`},max:{control:`number`,description:`Maximum value`},label:{control:`text`,description:`Accessible label`},variant:{control:`select`,options:[`accent`,`success`,`warning`,`error`,`neutral`],description:`Semantic color variant`},isLabelHidden:{control:`boolean`,description:`Visually hide the label`},hasValueLabel:{control:`boolean`,description:`Show formatted value`},isDisabled:{control:`boolean`,description:`Disabled state (grayed out)`}}},o={args:{value:60,label:`Progress`}},s={args:{value:75,label:`Storage used`,hasValueLabel:!0}},c={args:{value:3.2,max:5,label:`Disk usage`,hasValueLabel:!0,formatValueLabel:(e,t)=>`${e} GB / ${t} GB`}},l={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,width:`300px`},children:[(0,i.jsx)(n,{value:60,label:`Accent`,variant:`accent`,hasValueLabel:!0}),(0,i.jsx)(n,{value:80,label:`Success`,variant:`success`,hasValueLabel:!0}),(0,i.jsx)(n,{value:50,label:`Warning`,variant:`warning`,hasValueLabel:!0}),(0,i.jsx)(n,{value:92,label:`Error`,variant:`error`,hasValueLabel:!0}),(0,i.jsx)(n,{value:35,label:`Neutral`,variant:`neutral`,hasValueLabel:!0})]})},u={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,width:`300px`},children:[(0,i.jsx)(n,{value:30,label:`Upload canceled`,isDisabled:!0,hasValueLabel:!0}),(0,i.jsx)(n,{isIndeterminate:!0,label:`Processing disabled`,isDisabled:!0})]})},d={name:`Composed: with description`,render:()=>(0,i.jsxs)(`div`,{style:{width:`300px`},children:[(0,i.jsx)(n,{value:40,max:100,label:`Download progress`,hasValueLabel:!0}),(0,i.jsx)(`div`,{style:{fontSize:`12px`,color:`var(--color-text-secondary)`,marginTop:`4px`},children:`40 MB / 100 MB downloaded`})]})},f={args:{value:50,label:`Loading progress`,isLabelHidden:!0}},p={args:{value:75,label:`Upload`,isLabelHidden:!0,hasValueLabel:!0}},m={args:{value:0,label:`Not started`,hasValueLabel:!0}},h={args:{value:100,label:`Complete`,hasValueLabel:!0,variant:`success`}},g={args:{isIndeterminate:!0,label:`Loading...`}},_={args:{isIndeterminate:!0,label:`Loading`,isLabelHidden:!0}},v={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,width:`300px`},children:[(0,i.jsx)(n,{isIndeterminate:!0,label:`Accent`,variant:`accent`}),(0,i.jsx)(n,{isIndeterminate:!0,label:`Success`,variant:`success`}),(0,i.jsx)(n,{isIndeterminate:!0,label:`Warning`,variant:`warning`}),(0,i.jsx)(n,{isIndeterminate:!0,label:`Error`,variant:`error`}),(0,i.jsx)(n,{isIndeterminate:!0,label:`Neutral`,variant:`neutral`})]})},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    value: 60,
    label: 'Progress'
  }
