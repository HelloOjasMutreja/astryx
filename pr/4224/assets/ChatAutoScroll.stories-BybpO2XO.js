import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{t as r}from"./Text-c5LWyKai.js";import{t as i}from"./jsx-runtime-cM__dR4X.js";import{t as a}from"./Button-D16xsf4E.js";import{t as o}from"./Button-Ncr6y4Fk.js";import{n as s,t as c}from"./Badge-B_PS94vK.js";import{i as l,t as u}from"./CodeBlock-E9kd_YV1.js";import{t as d}from"./Text-_h16ESYs.js";import{c as f,g as p,o as m,t as h,v as g,w as _}from"./Chat-DLrplaxs.js";import{n as v,t as y}from"./Markdown-B8Z74ut-.js";var b,x,S,C,w,T,E,D,O;t((()=>{h(),y(),o(),d(),u(),c(),b=e(n()),x=i(),S={title:`Core/ChatAutoScroll`,tags:[`autodocs`],parameters:{layout:`fullscreen`}},C=`Let me analyze this codebase for you. I'll start by looking at the project structure and understanding the architecture.
...
│ (shared observer)   │
└─────────────────────┘`,language:`text`})]})}])},[]),S=(0,b.useCallback)(()=>{clearInterval(o.current),i(!1),c.current=0,t([{id:1,role:`user`,text:`Can you analyze the auto-scroll system and fix the issue with tool calls?`},{id:2,role:`assistant`,text:"Sure, I'll look into the auto-scroll behavior. Let me start by reading the relevant files.\n\nThe scroll system uses `useChatStreamScroll` for spring-based scroll tracking and `useChatNewMessages` for content observation."},{id:3,role:`user`,text:`Great, show me what you find.`}])},[]);return(0,x.jsxs)(`div`,{className:`x1dr59a3 x78zum5 xdt5ytf`,children:[(0,x.jsxs)(`div`,{className:`x78zum5 x167g77z xc7ga6q x4befzd x1a02dak x6s0dn4`,children:[(0,x.jsx)(a,{label:`Stream Text (works ✓)`,variant:`primary`,size:`sm`,onClick:u,isDisabled:n}),(0,x.jsx)(a,{label:`Add Tool Call (may fail ✗)`,variant:`secondary`,size:`sm`,onClick:d}),(0,x.jsx)(a,{label:`Batch Tool Calls (likely fails ✗)`,variant:`secondary`,size:`sm`,onClick:h}),(0,x.jsx)(a,{label:`Add Custom Element (may fail ✗)`,variant:`secondary`,size:`sm`,onClick:y}),(0,x.jsx)(a,{label:`Reset`,variant:`ghost`,size:`sm`,onClick:S}),(0,x.jsx)(`div`,{className:`xvc5jky x78zum5 x6s0dn4 x17d4w8g`,children:(0,x.jsx)(s,{variant:n?`green`:`neutral`,label:n?`Streaming`:`Idle`})})]}),(0,x.jsx)(m,{composer:(0,x.jsx)(_,{onSubmit:()=>{},placeholder:`Observe auto-scroll behavior above...`,isStopShown:n}),children:(0,x.jsx)(g,{children:e.map(e=>(0,x.jsxs)(p,{sender:e.role,children:[e.text&&(0,x.jsx)(v,{density:`compact`,children:e.text}),e.toolCalls&&e.toolCalls.length>0&&(0,x.jsx)(f,{calls:e.toolCalls}),e.customElement]},e.id))})})]})}},E={name:`Rapid Tool Calls`,render:()=>{let[e,t]=(0,b.useState)([{id:1,role:`user`,text:`Run the full test suite across all packages.`}]),[n,r]=(0,b.useState)(!1),i=(0,b.useRef)(void 0),o=(0,b.useRef)(0),c=(0,b.useCallback)(()=>{r(!0),o.current=0,i.current=setInterval(()=>{if(o.current++,o.current>10){clearInterval(i.current),r(!1);return}let e=Date.now()+o.current,n=[`read`,`bash`,`edit`,`ipython`,`show`],a=[`Button.test.tsx`,`yarn test --filter=Button`,`Button.tsx +8 -2`,`analyze_coverage()`,`coverage-report.html`],s=(o.current-1)%n.length;t(t=>[...t,{id:e,role:`assistant`,text:``,toolCalls:[{key:String(e),name:n[s]??`read`,target:a[s],status:`running`,node:`astryx`}]}]),setTimeout(()=>{t(t=>t.map(t=>t.id===e?{...t,toolCalls:[{key:String(e),name:n[s]??`read`,target:a[s],status:`complete`,duration:`${(Math.random()*3+.1).toFixed(1)}s`,node:`astryx`}]}:t))},300)},500)},[]),l=(0,b.useCallback)(()=>{clearInterval(i.current),r(!1)},[]),u=(0,b.useCallback)(()=>{clearInterval(i.current),r(!1),o.current=0,t([{id:1,role:`user`,text:`Run the full test suite across all packages.`}])},[]);return(0,x.jsxs)(`div`,{className:`x1dr59a3 x78zum5 xdt5ytf`,children:[(0,x.jsxs)(`div`,{className:`x78zum5 x167g77z xc7ga6q x4befzd x1a02dak x6s0dn4`,children:[(0,x.jsx)(a,{label:n?`Running...`:`Start Rapid Tool Calls`,variant:`primary`,size:`sm`,onClick:c,isDisabled:n}),(0,x.jsx)(a,{label:`Stop`,variant:`destructive`,size:`sm`,onClick:l,isDisabled:!n}),(0,x.jsx)(a,{label:`Reset`,variant:`ghost`,size:`sm`,onClick:u}),(0,x.jsx)(`div`,{className:`xvc5jky x78zum5 x6s0dn4 x17d4w8g`,children:(0,x.jsx)(s,{variant:n?`yellow`:`neutral`,label:n?`Tool call ${o.current}/10`:`${e.length-1} messages`})})]}),(0,x.jsx)(m,{composer:(0,x.jsx)(_,{onSubmit:()=>{},placeholder:`Watch scroll behavior...`}),children:(0,x.jsx)(g,{children:e.map(e=>(0,x.jsxs)(p,{sender:e.role,children:[e.text&&(0,x.jsx)(v,{density:`compact`,children:e.text}),e.toolCalls&&e.toolCalls.length>0&&(0,x.jsx)(f,{calls:e.toolCalls})]},e.id))})})]})}},D={name:`Mixed Stream + Tools`,render:()=>{let[e,t]=(0,b.useState)([{id:1,role:`user`,text:`Fix the focus ring and run the tests.`}]),[n,r]=(0,b.useState)(`idle`),i=(0,b.useRef)(void 0),o=(0,b.useCallback)(()=>{r(`streaming`);let e=Date.now(),n=`Let me look at the Button component's focus styles and fix the ring.
