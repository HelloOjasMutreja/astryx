import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./jsx-runtime-DqZldVDK.js";import{t as n}from"./Button-CDqDGafa.js";import{t as r}from"./Button-Bhctu4N2.js";import{n as i,t as a}from"./Icon-Csbga5uN.js";import{n as o,t as s}from"./IconButton-5ABTroQS.js";import{t as c}from"./DropdownMenu-BVPj_8Ge.js";import{W as l,hi as u,mi as d}from"./iframe-cSV-3CCF.js";import{A as f,Jt as p,Kt as m,Sn as h,X as g,en as _,f as v,mn as y,t as b,wn as x}from"./esm-DA7gAIBC.js";var S,C,w,T,E,D,O,k,A,j,M,N,P;e((()=>{d(),r(),s(),a(),l(),b(),S=t(),C={title:`Core/ButtonGroup`,component:u,tags:[`autodocs`],argTypes:{orientation:{control:`select`,options:[`horizontal`,`vertical`]},size:{control:`select`,options:[`sm`,`md`,`lg`]},elevation:{control:`inline-radio`,options:[`none`,`low`,`med`,`high`]}}},w={width:16,height:16},T={render:()=>(0,S.jsxs)(u,{label:`Clipboard actions`,children:[(0,S.jsx)(n,{label:`Copy`,icon:(0,S.jsx)(p,{style:w})}),(0,S.jsx)(n,{label:`Cut`,icon:(0,S.jsx)(f,{style:w})}),(0,S.jsx)(n,{label:`Paste`,icon:(0,S.jsx)(m,{style:w})})]})},E={render:()=>(0,S.jsxs)(u,{label:`Actions`,orientation:`vertical`,children:[(0,S.jsx)(n,{label:`Copy`}),(0,S.jsx)(n,{label:`Cut`}),(0,S.jsx)(n,{label:`Paste`})]})},D={render:()=>(0,S.jsxs)(u,{label:`Text formatting`,children:[(0,S.jsx)(o,{label:`Bold`,icon:(0,S.jsx)(i,{icon:y,size:`sm`})}),(0,S.jsx)(o,{label:`Italic`,icon:(0,S.jsx)(i,{icon:g,size:`sm`})}),(0,S.jsx)(o,{label:`Underline`,icon:(0,S.jsx)(i,{icon:v,size:`sm`}),tooltip:`Underline`})]})},O={render:()=>(0,S.jsxs)(u,{label:`History`,children:[(0,S.jsx)(n,{label:`Undo`,variant:`ghost`,icon:(0,S.jsx)(x,{style:w}),isIconOnly:!0}),(0,S.jsx)(n,{label:`Redo`,variant:`ghost`,icon:(0,S.jsx)(h,{style:w}),isIconOnly:!0})]})},k={render:()=>(0,S.jsxs)(`div`,{style:{display:`flex`,gap:16,alignItems:`center`},children:[(0,S.jsxs)(u,{label:`Small actions`,size:`sm`,children:[(0,S.jsx)(n,{label:`Copy`}),(0,S.jsx)(n,{label:`Paste`})]}),(0,S.jsxs)(u,{label:`Medium actions`,size:`md`,children:[(0,S.jsx)(n,{label:`Copy`}),(0,S.jsx)(n,{label:`Paste`})]}),(0,S.jsxs)(u,{label:`Large actions`,size:`lg`,children:[(0,S.jsx)(n,{label:`Copy`}),(0,S.jsx)(n,{label:`Paste`})]})]})},A={render:()=>(0,S.jsxs)(u,{label:`Save options`,children:[(0,S.jsx)(n,{label:`Save`,variant:`primary`}),(0,S.jsx)(n,{label:`Save options`,variant:`primary`,icon:(0,S.jsx)(_,{style:w}),isIconOnly:!0})]})},j={render:()=>(0,S.jsxs)(u,{label:`Merge options`,children:[(0,S.jsx)(n,{label:`Merge pull request`,variant:`primary`}),(0,S.jsx)(n,{label:`More merge options`,variant:`primary`,icon:(0,S.jsx)(_,{style:w}),isIconOnly:!0})]})},M={render:()=>(0,S.jsxs)(u,{label:`Edit actions`,children:[(0,S.jsx)(n,{label:`Edit`}),(0,S.jsx)(o,{label:`More options`,icon:(0,S.jsx)(_,{style:w})})]})},N={render:()=>(0,S.jsxs)(u,{label:`Approve action`,children:[(0,S.jsx)(n,{label:`Allow once`,variant:`primary`}),(0,S.jsx)(c,{hasChevron:!1,button:{label:`Allow options`,variant:`primary`,isIconOnly:!0,icon:(0,S.jsx)(i,{icon:`chevronDown`})},items:[{label:`Allow for 30 minutes`},{label:`Always allow`}]})]})},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
